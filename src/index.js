...
// const imageMaker = (imgURL) => {
//   const newImg = document.createElement("img");
//   newImg.src = imgURL;
//   return newImg;
// };
// const newImges = imageData.map((img) => {
//   return imageMaker(img.imageURL);
// });
...
const newPanels = panelData.map((data) => {
  return makePanel(data.title, data.content);
});
